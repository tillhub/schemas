...
module.exports = {
  ...
  properties: {
    ...
    amount: {
      ...
      type: 'integer',
      example: 1850,
      description: 'The daily amount for this payment option, tips included'
    },
    amount_tip: {
      deprecated: true,
      ...oneOf({
        type: 'integer',
        example: 1850,
        description: 'The daily tip amount for this payment option'
      })
    },
    discrepancy: {
      deprecated: true,
      ...oneOf({
        type: 'integer',
        example: 1850,
        description: 'The daily discrepancy between calculated and counted amounts, POS: counted - calculated, not available anymore for non-cash types (e.g. terminal)'
      })
    },
    exchangeRate: {
      ...oneOf({
