...
module.exports = {
  ...
  properties: {
    ...
    sales: {
      ...oneOf({
        description: 'The total of all sales for this staff (including tip items)',
        ...currencyAmount
      })
    },
    change: {
    ...
    tips_total: {
      ...oneOf({
        description: 'The total amount of tips (customer -> cashier) for this staff, regardless of salesperson',
        ...currencyAmount
      })
    },
    tips_cash: {
      ...oneOf({
        description: 'The total amount of cash tips (customer -> cashier) for this staff, regardless of salesperson',
        ...currencyAmount
      })
    },
    tips_balance: {
      ...oneOf({
        description: 'The total tips reduced by already payed out tips via tip-expenses',
        ...currencyAmount
      })
    },
    payments: oneOf({
      ...
      items: {
        ...
        properties: {
          ...
          amount_given: {
            ...oneOf({
              description: 'The given amount per this payment option - to support legacy handling with top level change.',
              ...currencyAmount
            })
          },
          amount: {
            ...oneOf({
              description: 'The amount per this payment option. If this is the first entry of type cash - it will reduce amount_given by change',
              ...currencyAmount
            })
          },
          amount_tip: {
