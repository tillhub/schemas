...
const totalSalesByVat = require('./total_sales_by_vat/base')
const transactionsPerHour = require('./transactions_per_hour/base')
...
module.exports = {
  ...
  timezone,
  total_amount_tx_gross: {
    default: 0,
    description: 'The total amount of transactions gross.',
    type: 'number',
    minimum: 0,
    maximum: 1000000,
    multipleOf: 0.01
  ...
  total_amount_tx_net: {
    default: 0,
    description: 'The total amount of transactions net.',
    type: 'number',
    minimum: 0,
    maximum: 1000000,
    multipleOf: 0.01
  ...
  average_cart_amount: {
    default: 0,
    description: 'The average cart amount.',
    type: 'number',
    minimum: 0,
    maximum: 1000000,
    multipleOf: 0.01
  ...
  bon_number: {
    ...oneOf({
      type: 'object',
      additionalProperties: false,
      example: '{ "first": "abc123", "last": "def456"}',
      description: 'The first and last bon numbers.',
      required: [
        'first',
        'last'
      ],
  ...
  abs_amount_vouchers_sold: {
    type: 'number',
    description: 'The absolute amount of vouchers sold.',
    example: 50,
    'minimum': 0,
    'maximum': 32767,
    'multipleOf': 1
  ...
  average_shopping_cart: {
    default: 0,
    description: 'The average of shopping carts.',
    type: 'number',
    minimum: 0,
    maximum: 1000000,
    multipleOf: 0.01
  },
  average_products_in_cart: {
    default: 0,
    description: 'The average number of products in cart.',
    type: 'number',
    minimum: 0,
    maximum: 1000000,
    multipleOf: 0.01
  },
  transactions_per_hours: {
    type: 'array',
    items: {
      ...transactionsPerHour
    }
