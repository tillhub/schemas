...
module.exports = {
  ...
  type: {
    anyOf: [
      {
        type: "string",
        enum: ["fullpos-mobile", "gastropos-mobile", "fullpos-stationary", "litepos-mobile"]
      },
      {
        type: "null"
      }
        ...
        properties: {
          device_token: {
            ...oneOf({
              type: "string",
              description:
                "The Apple Push Notification Service (APNS) token that can be used to send push notifications to the device",
          ...
          counting_decisions: {
            ...oneOf({
              type: "array",
              description:
                "Reports a one-time decision about the register's counting numbers (set when initializing a safe storage, e.g. keychain)",
              items: {
                ...countingDecision
              }
            })
          ...
          fiscal_signing_type: {
            ...oneOf({
              description:
                "The fiscal signing type to use, e.g. Fiskaltrust in Austria or EposnTSE in Germany",
              type: "string",
              enum: ["fiskaltrust", "tse_fiskaly", "tse_epson", "fr_NF525", "it_epson"]
            })
          },
          fiscal_signing: {
            ...
            anyOf: [
              {
                ...
                properties: {
                  tss_id: {
                    type: "string",
                    description:
                      "UUID4 of the technical security system (TSS). Must be uniquely generated on the dashboard.",
                  ...
                  client_id: {
                    type: "string",
                    description:
                      "UUID4 of the register according to the signing unit. Must be uniquely generated on the dashboard.",
                  ...
                  client_serial_number: {
                    type: "string",
                    description:
                      "Prefix + generated UUID4 according to https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/Publikationen/TechnischeRichtlinien/TR03153/TR-03153.pdf?__blob=publicationFile. Must be uniquely generated on the dashboard.",
                  ...
                  base_url: {
                    ...oneOf({
                      type: "string",
                      description:
                        "A custom Fiskaly API endpoint. If not set, the POS will use the version specific default endpoint.",
                  ...
                  debug_level: oneOf({
                    type: "integer",
                    description:
                      "The granularity of a dedicated client side logfile. Valid debug levels are -1 (no output), 1 (errors only), 2 (errors+warnings) and 3 (errors+warnings+info).",
                    minimum: -1,
                    maximum: 3,
              ...
              },
              {
                ...
                properties: {
                  client_id: {
                    type: "string",
                    description:
                      "ID of the register according to the signing unit. This is NOT the Tillhub register UUID!",
                  ...
                  unit: {
                    ...oneOf({
                      type: "string",
                      description:
                        "ID of the signing unit (Epson.serialNumber) - should be updated after client is initialized",
                  ...
                  target: {
                    ...oneOf({
                      type: "string",
                      description:
                        "TSE target address (MAC) - should be updated after client is initialized",
                ...
                properties: {
                  unit: {
                    ...oneOf({
                      type: "string",
                      description:
                        "Eleven character ID of the signing unit (Epson.serialNumber) - should be updated after client is initialized",
                      example: "99IEB03890"
                    })
                  },
                  target: {
                    ...oneOf({
                      type: "string",
                      description:
                        "IP address of the signing unit - should be updated after client is initialized",
