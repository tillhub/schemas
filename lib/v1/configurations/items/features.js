...
module.exports = oneOf({
  ...
  properties: {
    ...
    manual_reference: oneOf({
      ...
      properties: {
        enabled: {
          description: 'Specifies if - for given conditions - an external reference can be assigned manually to a cart.',
          type: 'boolean',
          default: false
        },
        custom_hint: oneOf({
          description: 'Custom override of the text displayed next to the reference input UI.',
          type: 'string',
          example: 'Please enter the order number for this sale.',
          minLength: 2,
          maxLength: 128
        }),
        number_format: {
