...
module.exports = {
  ...
  properties: {
            ...
            properties: {
              ...
              job: {
                ...
                enum: [
                  ...
                  'analytics_snapshots_deposits_amount_total',
    ...
    aggregate_tips: {
      description: 'A flag to determine whether to include tips in analytics reports',
      type: 'boolean',
      default: false
    },
    aggregate_vouchers: {
      description: 'A flag to determine whether to include vouchers in analytics reports',
      type: 'boolean',
      default: false
    }
  }
