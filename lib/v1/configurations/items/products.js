      ...
      properties: {
        ...
        barcode_search_pattern: oneOf({
          ...
          examples: [
            ...
            '^(?:[0-9]{2})*([0-9]{8})[0-9]{6}$' // extracts digits 0-8|2-10 from a string of length 14|16, use \d for [0-9]
          ],
          default: 'null'
        }),
        serial_number_extraction_pattern: oneOf({
          ...
          examples: [
            ...
            '^(?:[0-9]{2})*[0-9]{8}([0-9]{6})$' // extracts digits 9-14|11-16 from a digit string of length 14|16, use \d for [0-9]
          ],
          default: 'null'
        }),
        show_product_number: {
