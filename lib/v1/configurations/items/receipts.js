...
const cartReceipt = {
  ...
  properties: {
    ...
    print_pager_number: oneOf({
      description: 'If a pager number is assigned - Defines if it will be printed on (e.g. just for the customer)',
      type: 'boolean',
      default: true
    }),
    print_order_number: oneOf({
      description: 'Defines if the order number will be printed on (e.g. just for the customer)',
      type: 'boolean',
      default: false
    }),
    ...
    print_discount_groups: oneOf({
      description: 'Defines if groupable discounts are printed',
      type: 'boolean',
      default: false
    }),
