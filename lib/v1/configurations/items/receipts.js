...
const cartReceipt = {
  ...
  properties: {
    ...
    print_salesman_policy: oneOf({
      description: 'Defines if and how the salesperson will be printed on the receipt',
      type: 'string',
      enum: [
        'number',
        'name',
...
const balanceReceipt = {
  ...
  properties: {
    ...
    print_total_sales: oneOf({
      description: 'Defines if the total number of sales will be printed on (only makes sense for balances)',
      type: 'boolean',
      default: true
    }),
    print_tips_section: oneOf({
      description: 'Defines if the extended tips-section will be printed on (currently only makes sense for balances)',
      type: 'boolean',
      default: true
    }),
    print_extended_stats: oneOf({
      description: 'Defines if the extended balance stats will be printed on (only makes sense for balances)',
      type: 'boolean',
      default: true
    })
  }
