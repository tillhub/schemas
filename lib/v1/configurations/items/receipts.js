...
const salesmanConfiguration = {
  style: oneOf({
    description: 'Defines how the salesperson will be printed on the receipt header',
    type: 'string',
    enum: [
      'number',
      'name'
  ...
  conditions: oneOf({
    description: 'Defines the conditions, e.g. is_unique on header level',
    type: 'array',
    items: {
      type: 'string',
      enum: [
