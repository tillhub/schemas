...
const request = {
  ...
  addon_groups: require('./properties/addons-groups').flat,
...
const response = {
  ...request,
  addon_groups: require('./properties/addons-groups').full,
  price_book_entries: require('./properties/price-book-entries').full
}
