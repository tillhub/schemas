...
module.exports = {
            ...
            items: {
              ...
              properties: {
                name: {
                  type: 'string',
                  examples: [
                    'reason' // used for the expense's or deposit's reason
                  ]
                },
                value: oneOf({
                  type: 'string'
      ...
      items: {
        ...
        properties: {
          name: {
            type: 'string',
            examples: [
              'name', // used for the transaction's title
              'desc' // used for the transaction's note
              // there seem to be some unused keys defined
            ]
          },
          value: oneOf({
            type: 'string'
  ...
  external_rewards: oneOf({
    ...
    properties: {
      type: {
        description: 'The type of the reward, e.g. Swiss Coop card',
        type: 'string',
        enum: [
          'coop'
        ]
      ...
      data: {
        description: stripIndents`
        Necessary data to book a delta on an external reward of type: type.
        `,
        anyOf: [
          {
            type: 'object',
            ...
            properties: {
              status: {
                type: 'string',
                description: 'Booking status of this delta - mutable - will be send as .pending initially',
                enum: [
                  'unknown',
                  'pending',
                  'declined',
