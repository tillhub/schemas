...
module.exports = {
  ...
  context: {
    ...
    properties: {
      name: {
        type: 'string',
        example: 'A sales name',
        description: 'Custom name for a transaction, currently not supported for regular sales, leftover from when saved carts were transactions'
      },
      desc: {
        type: 'string',
        example: 'A custom note',
        description: 'Custom note for a transaction, currently in use only for cancellation notes'
      }
    }
  },
  timezone,
