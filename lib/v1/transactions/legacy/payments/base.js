        ...
        properties: {
          name: {
            ...
            examples: [
              ...
              'voucher_user_id', // (voucherObject->external_account) If is_voucher, the dynamic user component (user account or external system)
              'voucher_external_system_id', // (voucherObject->external_voucher_system) If is_voucher and external, the associated voucher system inside an external system
