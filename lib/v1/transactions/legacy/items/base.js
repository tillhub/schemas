...
module.exports = {
  ...
  quantity: {
    ...
    type: 'number',
    example: 2.73,
    description: 'Quantity of the product in that item, supports floating point for e.g. 2.73 kg'
  },
  article_number: {
    deprecated: true,
  ...
  vat_amount_euro: {
    deprecated: true,
    type: 'number',
    example: 266.798319327731092,
    description: 'Numerical exact amount of the VAT before rounding, no HUF shift: 266.798319327731092 EUR == 266.798319327731092 HUF !!!'
  },
  discount_amount: {
    deprecated: true,
    type: 'integer',
  ...
  context: {
    ...
    properties: {
      return_reason: {
        type: 'string',
        format: 'json',
        description: 'Stringified version of \'returnReason\' object'
      },
      product_service_questions: {
        type: 'string',
        format: 'json',
        description: 'Stringified version of \'productServiceAnswerObject\' object'
      },
      note: {
        type: 'string',
        example: 'Slightly damaged',
        description: 'Cashier/customer note on this item'
      },
      related_transaction_guid: {
        type: 'string',
        example: '00040013000120190129091933432',
        description: 'In cases of refund or cancellation, or invoicing a delivery note or selling a saved cart: the GUID of the origin transaction'
      },
      voucher_value: {
        type: 'integer',
        example: 2500,
