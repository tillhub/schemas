...
const addonObject = require('../../components/embedded/addon/base')
...
module.exports = {
        ...
        properties: {
          name: {
            ...
            examples: [
              ...
              'voucher_liknked_product_id', // If is_voucher and of type product, the id of the discounted product
  ...
  _amount_net: oneOf({
    description: stripIndents`
    The payable net amount (unit * qty) of this cartitem, after decrementing applicable discounts (meaning including discounts) etc.
  ...
  _amount_gross: oneOf({
    description: stripIndents`
    The payable gross amount (unit * qty) of this cartitem, after decrementing applicable discounts (meaning including discounts) etc.
  ...
  _amount_total_net: oneOf({
    description: stripIndents`
    The payable net amount total, before decrementing applicable discounts etc.
    (unit * qty)
    `,
    type: 'number',
    minimum: -1000000,
  ...
  _amount_total_gross: oneOf({
    description: stripIndents`
    The payable gross amount total, before decrementing applicable discounts etc.
    (unit * qty)
      `,
    type: 'number',
    minimum: -1000000,
