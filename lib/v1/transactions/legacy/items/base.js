...
module.exports = {
  ...
  _amount_net: oneOf({
    // mapped from revenueNet_ : includes discounts but is not scaled to qty 1
    description: stripIndents`
  ...
  _amount_gross: oneOf({
    // mapped from revenueGross_ : includes discounts but is not scaled to qty 1
    description: stripIndents`
  ...
  _amount_total_net: oneOf({
    // mapped from amountTotalNet_ : currect full qty but before discounts
    description: stripIndents`
  ...
  _amount_total_gross: oneOf({
    // mapped from amountTotalGross_ : currect full qty but before discounts
    description: stripIndents`
  ...
  _amount_unit_net: oneOf({
    // mapped from amountUnitNet_ : currect qty 1, correct before discounts
    description: stripIndents`
  ...
  _amount_unit_gross: oneOf({
    // mapped from amountUnitGross_ : currect qty 1, correct before discounts
    description: stripIndents`
