...
module.exports = {
  ...
  article_number: oneOf({
    deprecated: true,
    description: 'Apparently not used'
  }),
  article_attr_desc: oneOf({
    deprecated: true,
    description: 'Apparently not used'
  }),
  article_price: oneOf({
  ...
  related_transaction_number: oneOf({
    deprecated: true,
    type: 'integer',
    example: 49,
  ...
  related_transaction_date: oneOf({
    deprecated: true,
    type: 'string',
    format: 'date-time',
  ...
  related_transaction_type: oneOf({
    deprecated: true,
    type: 'string',
    enum: [
      'sale',
  ...
  reference_cartitem_client_id: oneOf({
    deprecated: true,
    type: 'string',
      ...
      properties: {
        name: {
          ...
          examples: [
            ...
            'voucher_system_system', // If is_voucher, the associated Tillhub subsystem resource of the voucher
