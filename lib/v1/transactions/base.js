...
const relatedObject = require('../transactions/reference/related')
const dependsObject = require('../transactions/reference/depends')
const originObject = require('../transactions/reference/origin')
