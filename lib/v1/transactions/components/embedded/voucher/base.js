...
module.exports = {
  ...
  properties: {
    ...
    external_account: {
      description: 'If using a parent\'s voucher system, this is the account id of the delegating parent, e.g. vouchers/{external_account}/lookup?code=xyz123&system={external_voucher_system}.',
      default: null,
      ...oneOf({
        type: 'string',
        maxLength: 128,
    ...
    external_voucher_system: {
      description: 'If using a parent\'s voucher system, this is the voucher system id inside the delegating parent, e.g. vouchers/{external_account}/lookup?code=xyz123&system={external_voucher_system}.',
      default: null,
      ...oneOf({
        type: 'string',
        maxLength: 128,
