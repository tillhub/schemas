...
module.exports = {
  ...
  properties: {
    ...
    external_system_id: {
      ...
      default: null,
      ...oneOf({
        description: 'Replace own accountid in requests, e.g. /vouchers/(accountId OR external_system_id)/voucher_id',
        type: 'string',
        maxLength: 128,
        example: '0023903408'
      })
    ...
    delegate_system_id: {
      description: 'If deleagted, delegate system id (e.g. WAX headquarter account) - to be send in all requests as query parameter.',
      default: null,
      ...oneOf({
