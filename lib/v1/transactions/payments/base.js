...
const voucherObject = require('../voucher/base')

const relatedObject = require('../reference/related')
const dependsObject = require('../reference/depends')
const originObject = require('../reference/origin')
...
module.exports = {
  ...
  account_change: {
    ...
    ...oneOf({
      type: 'string',
      description: 'The applicable Tillhub account for the cash payment type.',
      example: 'a5380b42-6025-49de-bb1d-c9357df96506'
    })
  },
  client_id: {
