module.exports.staff = {
  $id: 'https://schemas.tillhub.com/common/permissions.staff.request.schema.json',
  ...
  items: {
    ...
    enum: [
      ...
      'staff:staff:transactions:cart:products:services', // only allow selling services when this scope is set
