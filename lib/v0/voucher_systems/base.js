...
module.exports = {
  ...
  template: {
    description: 'Define an attribute template for vouchers that will be created from this system. Behaviour of vouchers can always be overriden.',
    ...oneOf({
      type: 'object',
      description: 'Inhertiable properties from Tillhub Vouchers',
      required: [
        'format',
        'format_type'
      ],
