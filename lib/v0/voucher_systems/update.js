...
module.exports.templates = {
  request: {
    $id: 'https://schemas.tillhub.com/v0/voucher_systems.templates.update.request.schema.json',
    $schema: 'http://json-schema.org/draft-07/schema#',
    ...templateBase,
    required: []
  },
  response: {
    $id: 'https://schemas.tillhub.com/v0/voucher_systems.templates.update.response.schema.json',
    $schema: 'http://json-schema.org/draft-07/schema#',
    ...templateBase,
    required: [
