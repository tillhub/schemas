  ...
  ...oneOf([
    {
      ...
      properties: {
        ...
        product: {
          description: 'The Tillhub product resource associated with this action to redeem or charge a voucher.',
          ...oneOf({
            type: 'string',
            format: 'uuid',
            example: '43847a66-97dc-4ac2-8e8a-c44920e1f22f'
    ...
    },
    {
      ...
      properties: {
        ...
        product: {
          description: 'The Tillhub product resource associated with this action to create a voucher.',
          ...oneOf({
            type: 'string',
            format: 'uuid',
            example: '43847a66-97dc-4ac2-8e8a-c44920e1f22f'
