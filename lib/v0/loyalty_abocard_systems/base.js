...
module.exports.properties = {
  ...
  linked_product: oneOf({
    description: 'Product liked to abocard system. New products being created for "actions[...].product" and "voucher_system.product" based on this value (VAT ID reference is most important part).',
