...
const latestRequest = {
  $id: 'https://schemas.tillhub.com/v0/cashier_counting_protocols.get.latest.request.schema.json',
...
const latestResponse = {
  $id: 'https://schemas.tillhub.com/v0/cashier_counting_protocols.get.latest.response.schema.json',
  $schema: 'http://json-schema.org/draft-07/schema#',
  additionalProperties: true,
  type: 'object',
  required: [
