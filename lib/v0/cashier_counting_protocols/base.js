...
module.exports = {
  ...
  balance_number: oneOf({
    description: 'The counting number of the balance that this protocol will be contained in',
    type: 'integer'
  }),
  balance_last: oneOf({
    type: 'string',
    ...
    description: 'The Tillhub balance resource ID of the previous balance'
  }),
