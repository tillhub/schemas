...
module.exports = {
  ...
  issuable: { // ask Robert - cannot find use in API
    description: '',
    type: 'boolean'
  },
  reissuable: { // ask Robert - cannot find use in API
    description: '',
    type: 'boolean'
  },
  issuer: oneOf({
  ...
  bound_to: { // ask Robert - cannot find use in API
    description: '',
    type: 'object'
  },
  namespace: { // ask Robert - cannot find use in API
    description: '',
    type: 'string'
  },
  type: {
  ...
  mutable: { // ask Robert - cannot find use in API
    description: '',
    type: 'boolean'
  },
  exchange_for_cash: {
  ...
  restriction_single_transaction: { // ask Robert - cannot find use in API
  ...
  system: {
    description: `The voucher system this voucher gets its behaviour from and and will be matched upon lookup.`,
    default: null,
    ...oneOf({
      type: 'string',
      format: 'uuid',
