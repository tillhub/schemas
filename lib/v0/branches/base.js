...
module.exports = {
  ...
  created_at: {
    description: 'When the product was created. It was added for creating branches coming from MMS',
    oneOf: [
      {
        type: 'string',
        format: 'date-time',
  ...
  updated_at: {
    description: 'When the product was last updated. It was added for creating branches coming from MMS',
    oneOf: [
      {
        type: 'string',
        format: 'date-time',
