...
const eventBaseData = pick({
  ...
  type: {
    ...baseStockBook.type,
    description: `The type of stock booking: 'transfer' - booking by operator due to logistics workflow, 'sale' - booking due to sales workflow, 'delivery_note' - booking due to delivery notes workflow`,
    enum: eventTypeEnum
  }
