        ...
        properties: {
          lookup: {
            ...
            properties: {
              ...
              outgoing: oneOf({
                ...hook,
                description: 'The hook is called when a loyalty card is being looked up by its code. This incoming hook applies after the results returned from the internal and external queries and right before the response is returned to the caller. The hook receives in the body an object with the property "cards". The expected response from the hook is an object with the key of "cards", similar to the received value and a status of "200".'
              })
            }
          }
        }
