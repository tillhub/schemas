        ...
        properties: {
          book: {
            ...
            properties: {
              voucher: oneOf({
                ...hook,
                description: 'The hook receives an object with the properties values, customer, and products. The expected response from the hook is an array of objects with amount and unit. If the "destination_type" is "voucher", then the units are expected to be a "real" currency ["EUR", "USD", "CHF"]'
              })
            }
          }
        }
