...
module.exports = {
  ...
  eligible_products: oneOf({
    type: 'array',
    description: 'Array of uuids. Only these products will generate an value entry in the loyalty account. It is additive with eligible_product_groups.'
  }),
  eligible_product_groups: oneOf({
    type: 'array',
    description: 'Array of uuids. Only these product groups will generate an value entry in the loyalty account. It is additive with eligible_products.'
  }),
  branches: oneOf({
    type: 'array',
    description: 'Array of uuids. Only these branches will generate an value entry in the loyalty account.'
  }),
  region: oneOf({
    type: 'string',
